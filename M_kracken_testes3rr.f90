...
! NOTE:   many parameters were reduced in size so as to just accomodate being used as a command line parser.
...
!-----------------------------------------------------------------------------------------------------------------------------------
      ...
      ! before user slections are applied
...
!-----------------------------------------------------------------------------------------------------------------------------------
   do i=1,command_argument_count()                            ! append any arguments together
      ...
      istring_len_new=istring_len+ilength+1                   ! calculate total string length plus one for a seperator
...
! minor cleanup 
! updated 20131214
! added preliminary setprompt and menu as routines to explore prompting modes.
!-----------------------------------------------------------------------------------------------------------------------------------
! updated 20131206
